// Задача 9
    ...
    // !"2" Функция Поиск максимума из 3х
...
*/
        ...
        // "3" 
        //array [0]=12; //0му значению массива присвоили число 12
        //Console.WriteLine(array[4]); // Получить значение по указанному индексу (4 например)
    /* "2" 
